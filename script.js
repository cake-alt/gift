...
var madLibs = function () {
    ...
    storyDiv.innerHTML = "Shhh! It's your secret birthday today. I want to wish you a very happy birthday. It seems like just yesterday we were watching Evangelion with the eva gang and giggling at the memes of our personality type. My " + device.toLowerCase() + " has a petname for you. She keeps calling you Enrich whenever you show up hehehe. She thinks you are the icing on the cake! " + "To my charming friend, I wish you live your life like a " + chess.toLowerCase() + " for a day, " + "have a lifetime supply of " + food.toLowerCase() + ", " + " go swimming with " + celebrity + " on the beach." + " You always have a special place in our " + body.toLowerCase() + ". We wish you a happy birthday, we wish you a happy birthday and a happy " + holiday + ".";
}
